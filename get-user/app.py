...
def lambda_handler(event, context):
    ...
    assRole = sts_connection.assume_role(
        RoleArn="arn:aws:iam::xxxxxxxxxxx:role/userAssumeRole",
...
def get_policy(leading_key):
    print(leading_key)
    return "{\"Version\":\"2012-10-17\",\"Statement\":[{\"Effect\":\"Allow\",\"Action\":[\"dynamodb:GetItem\",\"dynamodb:BatchGetItem\",\"dynamodb:Query\"],\"Resource\":[\"arn:aws:dynamodb:ap-northeast-1:xxxxxxxxx:table/Sample\"],\"Condition\":{\"ForAllValues:StringEquals\":{\"dynamodb:LeadingKeys\":[\"" + leading_key + "\"]}}}]}"
